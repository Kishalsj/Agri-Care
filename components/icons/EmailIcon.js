export default function EmailIcon() {
  return (
    <svg
      ...
      height="30"
      viewBox="0 0 30 30"
      className="bg-[#EFEFEF] rounded-full"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M9 11L11.1589 12.7991C12.9955 14.3296 13.9139 15.0949 15 15.0949C16.0861 15.0949 17.0045 14.3296 18.8411 12.7991L21 11"
        stroke="#002248"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
